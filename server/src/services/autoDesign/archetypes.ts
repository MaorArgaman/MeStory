/**
 * SERVER MIRROR of client/src/components/autoDesign/archetypes.ts — the taste
 * matrix. Kept byte-identical (same pools, same array order) to the client so
 * the DOCX renderer composes the SAME genome the preview does. Edit both copies
 * together.
 */

import type { DesignSystemId } from './designPlanSchema';
