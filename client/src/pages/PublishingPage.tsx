          ...
          {step === 1 && (
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                ...
                <h2 className="text-xl sm:text-2xl font-bold">{t('publishing.steps.quality')}</h2>
              </div>
              ...
              {book.qualityScore ? (
                <div>
                  ...
                  {canProceedFromStep1 ? (
                    <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 bg-green-500/10 border border-green-500/30 rounded-lg mb-4 sm:mb-6">
                      ...
                      <div>
                        <p className="text-sm sm:text-base text-green-300 font-medium">{t('publishing.quality.ready')}</p>
                        <p className="text-xs sm:text-sm text-green-400/80">
                          {t('publishing.quality.ready_desc')}
                        </p>
                      </div>
                    </div>
                  ) : (
                    <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 bg-red-500/10 border border-red-500/30 rounded-lg mb-4 sm:mb-6">
                      ...
                      <div>
                        <p className="text-sm sm:text-base text-red-300 font-medium">{t('publishing.quality.low_score')}</p>
                        <p className="text-xs sm:text-sm text-red-400/80">
                          {t('publishing.quality.low_score_desc')}
                        </p>
                      </div>
                    </div>
                  )}
                ...
                <div className="flex items-start gap-2 sm:gap-3 p-3 sm:p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg mb-4 sm:mb-6">
                  ...
                  <div>
                    <p className="text-sm sm:text-base text-yellow-300 font-medium">{t('publishing.quality.no_score')}</p>
                    <p className="text-xs sm:text-sm text-yellow-400/80">
                      {t('publishing.quality.no_score_desc')}
                    </p>
                  </div>
                </div>
              )}
              ...
              <div className="flex flex-col-reverse sm:flex-row justify-between gap-3 sm:gap-4">
                <button onClick={() => navigate('/dashboard')} className="btn-secondary text-sm sm:text-base">
                  ...
                  <span className="hidden sm:inline">{t('publishing.buttons.back_dashboard')}</span>
          ...
          {step === 2 && (
            ...
            >
              <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                ...
                <h2 className="text-xl sm:text-2xl font-bold">{t('publishing.steps.pricing')}</h2>
              </div>

              <div className="space-y-4 sm:space-y-6">
                {/* Pricing */}
                <div>
                  <label className="block text-sm font-medium mb-2">{t('publishing.pricing.title')}</label>
